...
void main() {
  ...
  test('stress test: host and 30 guests survive repeated activity waves', () async {
    ...
    final guests = List<PartyRoomController>.generate(30, (_) => createController());
    ...
    expect(guests.every((guest) => guest.room!.participantCount == 31), isTrue);
    ...
    for (var wave = 0; wave < 4; wave++) {
      ...
      await _settle();
      expect(host.room!.nowPlayingTrackId, isNot(topTrackBeforePlay));
